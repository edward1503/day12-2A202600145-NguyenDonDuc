        ...
        *,
        ...
        if self.use_llm_judge:
            ...
            if not safety_result["safe"]:
                ...
                # Block entirely and return a safe generic message
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="I'm sorry, but I cannot provide that information as it may violate health or safety policies.")],
                )
